...
Feature_names_red = Feature_names_red[selector.get_support()]
print(Feature_names_red)
...
hmda_features_sel = pd.DataFrame(Features_reduced, columns = Feature_names_red)
hmda_features_sel.to_csv('hmda_features_red.csv', index=False)
hmda_features_new_sel = pd.DataFrame(Features_new_reduced, columns = Feature_names_red)
